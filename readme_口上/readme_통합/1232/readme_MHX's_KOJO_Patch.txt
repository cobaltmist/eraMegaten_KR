...
MHX's add patch_20210709 (must install)


＜Contents＞

Adds KOJO file for Mysterious Heroine X and Mysterious Heroine X Alter.

* Both of them only have 1 Japanese RPG KOJO file inside. Take a try to write some ERB,if you want them to talk during your journey. *
...
If you've already installed the required patch files,copy and paste the ERB folder to original one.
