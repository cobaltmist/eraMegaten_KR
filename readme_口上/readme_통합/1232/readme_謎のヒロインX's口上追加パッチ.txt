...
＜対象環境＞
eraMegaten0.309＋0.309用修正6+私家版パッチ纏め_Rev132+Rev136+Rev136ちょっと修正を導入済み(必須環境)
eraMegaten_Rev136用不具合等修正パッチ（必須）
謎のヒロインX's追加パッチ_20210622

＜内容＞

・謎のヒロインXと謎のヒロインXオルタ用の口上ファイルを追加。


＜導入方法＞
導入前に対象環境のパッチを事前に適用しているか確認してください。

適用したのを確認した後に、同梱されたERBフォルダをそのまま本体にコピペしてください。
